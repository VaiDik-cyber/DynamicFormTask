...
const Form1 = () => {
  ...
  const handlerChecked = (item) => {
    const isChecked = currentField.checkedOption.includes(item);
    const updatedCheckedOption = isChecked
      ? currentField.checkedOption.filter((value) => value !== item)
      : [...currentField.checkedOption, item];

    setCurrentField({
      ...currentField,
      checkedOption: updatedCheckedOption,
    });
  };
                  ...
                  return (
                    <div key={index}>
                      ...
                      <input
                        ...
                        type="checkbox"
                        checked={
                          currentField.checkedOption?.includes(item) || false
                        }
                        value={item}
                        required={field.required}
                        onChange={() => {
